...
export class ContentListComponent {
  public contentData: Content[] = [
    ...
    { id: 6, title: 'Cosmetics', description: 'Every Brand is available and full of quality', creator: 'Grocery Market', imgURL: 'https://www.gosupps.com/media/catalog/product/7/1/71Axd0y3QXL.jpg', type: 'Grocery Item', tags: ['Make-up', 'Acessories'] },
  ];
  constructor() { }
